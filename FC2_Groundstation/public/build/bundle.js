...
var app = (function () {
    ...
    const file$6 = "src\\components\\DataRow.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	let t5;
    	let p3;
    	let t6_value = /*data*/ ctx[0].signalStrength + "";
    	let t6;
    	let t7;
    	let div2;
    	let p4;
    	let t9;
    	let p5;
    	let t10_value = /*data*/ ctx[0].finSetpoint + "";
    	let t10;
    	let t11;
    	let div3;
    	let p6;
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*data*/ 1 && t6_value !== (t6_value = /*data*/ ctx[0].signalStrength + "")) set_data_dev(t6, t6_value);
    			if (dirty & /*data*/ 1 && t10_value !== (t10_value = /*data*/ ctx[0].finSetpoint + "")) set_data_dev(t10, t10_value);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(data_1, file$7, 5, 0, 88);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	function graphs_rocketData_binding(value) {
    		/*graphs_rocketData_binding*/ ctx[8].call(null, value);
    	}

    	function graphs_dataWindow_binding(value) {
    		/*graphs_dataWindow_binding*/ ctx[9].call(null, value);
    	}
